...
#define MAX_KEY_LENGTH			32		//对称密钥存储空间最大长度
...
//赢达信专用接口
SGD_RV SDF_GetCryptKey(SGD_HANDLE hSessionHandle, SGD_UINT32 uiAlgID, SGD_UINT32 uiKEKIndex, SGD_UCHAR *pucKey, SGD_UINT32 uiKeyType, SGD_UINT32 uiKeyNumber, SGD_UCHAR *pucKeyCipher, \
					   SGD_UINT32 *puiKeyCipherLen);
SGD_RV SDF_PutCryptKey(SGD_HANDLE hSessionHandle, SGD_UINT32 uiAlgID, SGD_UINT32 uiKEKIndex, SGD_UCHAR *pucKey, SGD_UINT32 uiKeyType, SGD_UINT32 uiKeyNumber, SGD_UCHAR *pucKeyCipher, \
					   SGD_UINT32 uiKeyCipherLen);
SGD_RV SDF_SubKeysDistribute(SGD_HANDLE hSessionHandle, SGD_UINT32 uiAlgID, SGD_UINT32 uiKEKIndex, SGD_UCHAR *pucID, SGD_HANDLE *phKeyHandle);
SGD_RV SDF_GetCryptSubKey(SGD_HANDLE hSessionHandle, SGD_UINT32 uiAlgID, SGD_UINT32 uiKEKIndex, SGD_UCHAR *pucKey, SGD_HANDLE hSubKeyHandle, SGD_UCHAR *pucSubKeyCipher, \
						SGD_UINT32 *puiSubKeyCipherLen);
SGD_RV SDF_PutCryptSubKey(SGD_HANDLE hSessionHandle, SGD_UINT32 uiAlgID, SGD_UINT32 uiKEKIndex, SGD_UCHAR *pucKey, SGD_UCHAR *pucSubKeyCipher, SGD_UINT32 uiSubKeyCipherLen, SGD_HANDLE *phKeyHandle);
SGD_RV SDF_DeriveKEK(SGD_HANDLE hSessionHandle, SGD_UINT32 uiKEKIndex, SGD_UCHAR *pucSeed, SGD_UINT32 uiSeedLen);


SGD_RV SDF_GenerateTmpKeyPair_RSA(SGD_HANDLE hSessionHandle, SGD_UINT32 uiKeyBits, RSArefPublicKey *pucPublicKey);
SGD_RV SDF_GenerateTmpKeyPair_ECC(SGD_HANDLE hSessionHandle, SGD_UINT32 uiAlgID, SGD_UINT32 uiKeyBits, ECCrefPublicKey *pucPublicKey);
SGD_RV SDF_GenerateSubKey(SGD_HANDLE hSessionHandle, SGD_HANDLE hSrcKeyHandle, SGD_UINT32 uiAlgID, SGD_UCHAR *pucID, SGD_UINT32 uiIDLength, SGD_HANDLE *phSubKeyHandle);
SGD_RV SDF_ExportSubKeyWithEPK_RSA(SGD_HANDLE hSessionHandle, SGD_HANDLE hSubKeyHandle, RSArefPublicKey *pucPublicKey, SGD_UCHAR *pucKey, SGD_UINT32 *puiKeyLength);
SGD_RV SDF_ImportSubKeyToKEKWithISK_RSA(SGD_HANDLE hSessionHandle, SGD_UINT32 uiISKIndex, SGD_UINT32 uiKEKIndex, SGD_UCHAR *pucKey, SGD_UINT32 uiKeyLength);
SGD_RV SDF_ExportSubKeyWithEPK_ECC(SGD_HANDLE hSessionHandle, SGD_HANDLE hSubKeyHandle, SGD_UINT32 uiAlgID, ECCrefPublicKey *pucPublicKey, ECCCipher *pucKey);
SGD_RV SDF_ImportSubKeyToKEKWithISK_ECC(SGD_HANDLE hSessionHandle, SGD_UINT32 uiISKIndex, SGD_UINT32 uiKEKIndex, ECCCipher *pucKey);
SGD_RV SDF_GenerateSessionKey(SGD_HANDLE hSessionHandle, SGD_UINT32 uiSessionKeyLength, SGD_HANDLE *phSessionKeyHandle);
SGD_RV SDF_GetCryptSessionKey(SGD_HANDLE hSessionHandle, SGD_HANDLE hEncryptKeyHandle, SGD_UINT32 uiAlgID, SGD_HANDLE hSessionKeyHandle, SGD_UCHAR *pucSessionKeyCipher, SGD_UINT32 *puiSessionKeyCipherLen);
SGD_RV SDF_PutCryptSessionKey(SGD_HANDLE hSessionHandle, SGD_HANDLE hDecryptKeyHandle, SGD_UINT32 uiAlgID, SGD_UCHAR *pucSessionKeyCipher, SGD_UINT32 uiSessionKeyCipherLen, SGD_HANDLE *phSessionKeyHandle);
...
//赢达信专用接口
SGD_RV SDF_HashUpdateSessionKey(SGD_HANDLE hSessionHandle, SGD_HANDLE hSessionKeyHandle);
